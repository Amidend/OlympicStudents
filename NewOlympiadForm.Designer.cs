namespace OlympicStudents
{
    partial class NewOlympiadForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.Location = new Point(13, 308);
            ...
            label3.Location = new Point(13, 350);
            ...
            // textBox3
            // 
            textBox3.Location = new Point(147, 14);
            ...
            comboBox1.Items.AddRange(new object[] { "Школа", "Колледж", "Район", "Город", "Республиканская", "Международная" });
            comboBox1.Location = new Point(153, 311);
            comboBox1.Margin = new Padding(4, 3, 4, 3);
            comboBox1.Name = "comboBox1";
            comboBox1.Size = new Size(473, 29);
            comboBox1.TabIndex = 5;
            // 
            // comboBox2
            // 
            comboBox2.FormattingEnabled = true;
            comboBox2.Items.AddRange(new object[] { "Конференция", "Олимпиада" });
            comboBox2.Location = new Point(153, 353);
            comboBox2.Margin = new Padding(4, 3, 4, 3);
            comboBox2.Name = "comboBox2";
            comboBox2.Size = new Size(473, 29);
            comboBox2.TabIndex = 5;
            // 
            // comboBox3
            // 
            comboBox3.FormattingEnabled = true;
            comboBox3.Items.AddRange(new object[] { "Диплом I степени", "Диплом II степени", "Диплом III степени", "Грамота", "Сертификат", "Без награды" });
            comboBox3.Location = new Point(153, 395);
            comboBox3.Margin = new Padding(4, 3, 4, 3);
            comboBox3.Name = "comboBox3";
            comboBox3.Size = new Size(473, 29);
            comboBox3.TabIndex = 5;
            // 
            // comboBox4
            // 
            comboBox4.FormattingEnabled = true;
            comboBox4.Items.AddRange(new object[] { "Благодарность", "Доска почета", "Именная стипендия", "Скидка в оплате за обучение", "Без поощрения" });
            comboBox4.Location = new Point(153, 437);
            comboBox4.Margin = new Padding(4, 3, 4, 3);
            comboBox4.Name = "comboBox4";
            comboBox4.Size = new Size(473, 29);
            comboBox4.TabIndex = 5;
            // 
            // button1
            // 
            button1.Location = new Point(1693, 857);
            ...
            monthCalendar1.Location = new Point(201, 56);
